...
const TimeLineCard = ({ cardData }) => {
	...
	const cardStyle = cardData.spec === "studies" ? studiesStyle : cardData.spec === "training" ? trainingStyle : generalStyle;
	...
	const iconStyle = cardData.spec === "studies" ? studiesIconStyle : cardData.spec === "training" ? trainingIconStyle : generalIconStyle;
	...
	return (
		<VerticalTimelineElement
			...
			iconStyle={iconStyle}
			icon={
				cardData.spec === "studies" ? (
					<SlNotebook className="icon" />
				) : cardData.spec === "training" ? (
					<TbBarbell className="icon" />
				) : (
					<BsGear />
				)
			}
